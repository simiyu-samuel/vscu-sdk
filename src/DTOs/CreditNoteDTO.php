...
final class CreditNoteDTO
{
    ...
    public function __construct(
        public readonly string $creditNo,
        ...
        public readonly string $rfdRsnCd = '01',
    ...
    public static function make(array $data): self
    {
        ...
        return new self(
            creditNo: (string) ($data['creditNo'] ?? $data['invcNo'] ?? $data['credit_note_number'] ?? ''),
            ...
            cfmDt: (string) ($data['cfmDt'] ?? $data['credit_date'] ?? $data['invoice_date'] ?? ''),
            salesDt: (string) ($data['salesDt'] ?? $data['credit_date'] ?? $data['invoice_date'] ?? ''),
            pmtTyCd: (string) ($data['pmtTyCd'] ?? $data['payment_type'] ?? '01'),
            totAmt: (float) ($data['totAmt'] ?? $data['credit_amount'] ?? 0),
    ...
    {
        $required = [
            ['creditNo', 'invcNo', 'credit_note_number'],
